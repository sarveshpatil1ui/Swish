  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-gray-950 transition-colors duration-300">
      ...
      >
        ...
        {/* Logo */}
        <div className="p-6 border-b border-slate-200 dark:border-gray-800 flex-shrink-0">
        ...
        {/* User Info */}
        <div className="p-4 border-b border-slate-200 dark:border-gray-800 flex-shrink-0">
          <div className="flex items-center gap-3">
